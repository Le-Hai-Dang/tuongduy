const translations = {
    en: {
        ...
        heroText: "We provide free online health consultations and ultra-fast drug delivery within 3 hours in the Phu Quoc area with free shipping.",
        ...
        st3: "Step 3: After talking with the consultant, we will deliver the medicine within 3 hours if you place an order",
        sev1: "Free consultation",
        sev2: "Free delivery",
        sev3: "Ensure delivery of medicine within 3 hours in Phu Quoc area",
        head_hospital: "Branch images",
        logo: "Tuong Duy Pharmacy",
        contact_last: "Click to view product",
        footerAddressHeading: "Branch Addresses"
    },
    vi: {
        title: "Quầy Thuốc Tường Duy",
        heroTitle: "Tư vấn sức khỏe trực tuyến",
        heroText: "Chúng tôi cung cấp dịch vụ tư vấn sức khỏe trực tuyến miễn phí, giao thuốc tận nơi siêu tốc trong vòng 3 giờ khu vực Phú Quốc và miễn phí vận chuyển.",
        ...
        st3: "Bước 3: Sau khi nói chuyện với tư vấn viên, chúng tôi sẽ đến giao thuốc trong vòng 3 giờ nếu bạn có đặt thuốc",
        sev1: "Tư vấn miễn phí",
        sev2: "Giao hàng miễn phí",
        sev3: "Đảm bảo nhận thuốc trong vòng 3 giờ tại khu vực Phú Quốc",
        head_hospital: "Hình cảnh các chi nhánh",
        logo:"Quầy Thuốc Tường Duy",
        contact_last: "Bấm để xem sản phẩm",
...
function updatePageContent() {
    ...
    document.querySelector('.contact-last').textContent = translations[currentLanguage].contact_last;
}
